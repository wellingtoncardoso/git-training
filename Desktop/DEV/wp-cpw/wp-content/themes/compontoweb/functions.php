...
function cpw_scripts_styles(){
	...
	if(! is_admin()){
		...
		//external sources
		// wp_enqueue_style('fontGoogleRoboto','href="https://fonts.googleapis.com/css2?family=Antic+Slab&family=Roboto:wght@300;400;500;700;900&display=swap', array(), '1.0.0');
